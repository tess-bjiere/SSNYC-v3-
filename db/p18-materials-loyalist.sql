...
create table if not exists public.materials (
  ...
  background_color text,   -- trim / packaging: the stock / base colour
  print_color text,        -- trim / packaging: the printed-ink colour
...
alter table public.materials add column if not exists background_color text;
alter table public.materials add column if not exists print_color text;
